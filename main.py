...
class App(CTk.CTk):
    def __init__(self):
        ...
        self.logo = CTk.CTkImage(dark_image=Image.open(r"C:\\Users\\kiril\\Downloads\\pass\\logo.png"), size=(460, 150))
        self.logo.lable = CTk.CTkLabel(master=self, text="", image=self.logo)
        self.logo.lable.grid(row=0, column=0)
        ...
        self.cb_digits = CTk.CTkCheckBox(self.settings_frame, text="0-9", variable=self.cb_digits_var, onvalue=digits,
                                            offvalue="")
